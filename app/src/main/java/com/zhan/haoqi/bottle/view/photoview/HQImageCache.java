...
public class HQImageCache {

    private HQImageCache() {
    ...
    private static HQImageCache imageCache = null;

    public static synchronized HQImageCache getInstance() {
        if (imageCache == null) {
            imageCache = new HQImageCache();
        }
        return imageCache;
